...
import { Container, Grid2, Card, CardContent, CardMedia, Box, Typography, Button } from "@mui/material";
import Carousal from "../components/uicomponents/Carousal";
import AccordionComp from "../components/uicomponents/AccordionComp";
...
const categoryList = [
  ...
  },
  {
    ...
    description: "Discover stylish and trendy women's fashion collections.",
  },
  {
    title: "Electronics",
    description: "Find the latest gadgets, smartphones, and accessories.",
  },
];
  ...
  <Box sx={{ display: "flex", justifyContent: "center" }}>
    ...
    >
      ...
      <CardContent sx={{ flexGrow: 1, paddingBottom: 0 }}>
        <Typography variant="caption" sx={{ fontWeight: "bold", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" }}>
          {product.title}
        </Typography>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", padding: "10px" }}>
        ...
        <Button size="small" variant="outlined" color="secondary" sx={{ borderColor: "black", color: "black", backgroundColor: "white", "&:hover": { borderColor: "black", backgroundColor: "rgba(0, 0, 0, 0.05)" } }} onClick={() => onViewDetails(product.id)}>View Details</Button>
      </Box>
    </Card>
  </Box>
);
